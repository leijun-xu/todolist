...
function Home() {
        ...
        "Home.useEffect": ()=>{
            fetch('http://localhost:8080/api/todos').then({
                ...
                "Home.useEffect": (error)=>{
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('获取Todo列表失败');
                }
            }["Home.useEffect"]);
        }
    }["Home.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            const checkNotifications = {
                "Home.useEffect.checkNotifications": ()=>{
                    const now = new Date();
                    todos.forEach({
                        "Home.useEffect.checkNotifications": (todo)=>{
                            if (todo.notificationTime) {
                                ...
                                if (diff < oneMinute && !todo.notified) {
                                    // 推送通知
                                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$notification$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__notification$3e$__["notification"].open({
    ...
    const handleAddTodo = (values)=>{
        ...
        fetch('http://localhost:8080/api/todos', {
            ...
            form.resetFields();
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success('添加Todo成功');
        }).catch((error)=>{
            console.error('Error adding todo:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('添加Todo失败');
        });
    };
    // 处理编辑开始
    const handleEditStart = (todo)=>{
        ...
        const formValues = {
            ...todo,
            notificationTime: todo.notificationTime ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dayjs$2f$dayjs$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(todo.notificationTime) : null
        };
    ...
    const handleEditSave = (values)=>{
        ...
        fetch(`http://localhost:8080/api/todos/${editingTodo.id}`, {
            ...
            setEditingTodo(null);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success('更新Todo成功');
        }).catch((error)=>{
            console.error('Error updating todo:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('更新Todo失败');
        });
    };
    // 处理编辑取消
...
_s(Home, "O0sF8B2EgEMOfGF0QSjyLWUNr28=", false, function() {
    return [
